...
export const APPELLATIONS = {
  ...
  'listrac-médoc': { r: 'Bordeaux', c: 'rouge' }, 'lussac-saint-émilion': { r: 'Bordeaux', c: 'rouge' },
  'montagne-saint-émilion': { r: 'Bordeaux', c: 'rouge' }, 'puisseguin-saint-émilion': { r: 'Bordeaux', c: 'rouge' },
  'saint-georges-saint-émilion': { r: 'Bordeaux', c: 'rouge' }, 'cadillac côtes de bordeaux': { r: 'Bordeaux', c: 'rouge' },
  'castillon côtes de bordeaux': { r: 'Bordeaux', c: 'rouge' }, 'francs côtes de bordeaux': { r: 'Bordeaux', c: 'rouge' },
  'blaye côtes de bordeaux': { r: 'Bordeaux', c: 'rouge' }, 'sainte-foy bordeaux': { r: 'Bordeaux', c: 'rouge' },
  'bordeaux supérieur': { r: 'Bordeaux', c: 'rouge' }, 'crémant de bordeaux': { r: 'Bordeaux', c: 'effervescent' },
  'irancy': { r: 'Bourgogne', c: 'rouge' }, 'vézelay': { r: 'Bourgogne', c: 'blanc' },
  'bouzeron': { r: 'Bourgogne', c: 'blanc' }, 'montagny': { r: 'Bourgogne', c: 'blanc' },
  'pouilly-vinzelles': { r: 'Bourgogne', c: 'blanc' }, 'mâcon-villages': { r: 'Bourgogne', c: 'blanc' },
  'maranges': { r: 'Bourgogne', c: 'rouge' }, 'chorey-lès-beaune': { r: 'Bourgogne', c: 'rouge' },
  'flagey-échezeaux': { r: 'Bourgogne', c: 'rouge' }, 'vougeot': { r: 'Bourgogne', c: 'rouge' },
  'beaujolais-villages': { r: 'Beaujolais', c: 'rouge' },
  'luberon': { r: 'Rhône Sud', c: 'rouge' }, 'grignan-les-adhémar': { r: 'Rhône Sud', c: 'rouge' },
  'côtes du vivarais': { r: 'Rhône Sud', c: 'rouge' }, 'clairette de die': { r: 'Rhône Sud', c: 'effervescent' },
  'anjou-villages': { r: 'Loire', c: 'rouge' }, 'cabernet d\'anjou': { r: 'Loire', c: 'rosé' },
  'muscadet sèvre et maine': { r: 'Loire', c: 'blanc' }, 'rosé d\'anjou': { r: 'Loire', c: 'rosé' },
  'cour-cheverny': { r: 'Loire', c: 'blanc' },
  'corbières-boutenac': { r: 'Languedoc', c: 'rouge' }, 'cabardès': { r: 'Languedoc', c: 'rouge' },
  'malepère': { r: 'Languedoc', c: 'rouge' }, 'muscat de frontignan': { r: 'Languedoc', c: 'moelleux' },
  'muscat de lunel': { r: 'Languedoc', c: 'moelleux' },
  'les baux de provence': { r: 'Provence', c: 'rouge' }, 'pierrevert': { r: 'Provence', c: 'rouge' },
  'porto-vecchio': { r: 'Corse', c: 'rouge' },
  'saint-mont': { r: 'Sud-Ouest', c: 'rouge' }, 'tursan': { r: 'Sud-Ouest', c: 'rouge' },
  'brulhois': { r: 'Sud-Ouest', c: 'rouge' },
  'chignin-bergeron': { r: 'Savoie', c: 'blanc' }, 'seyssel': { r: 'Savoie', c: 'blanc' },
  'bugey': { r: 'Savoie', c: 'blanc' }, 'roussette du bugey': { r: 'Savoie', c: 'blanc' },
  'vin de savoie': { r: 'Savoie', c: 'blanc' },
  // ── Vin de France
